...
export const metadata: Metadata = {
  title: 'About Us',
  description:
    'Tourkokan — your ultimate guide to exploring the breathtaking beauty and cultural richness of the Tourkokan region. Discover beaches, forts, culture, and hidden gems.',
}

const features = [
  {
    icon: '🏖️',
    title: 'Discover Tourkokan',
    desc: 'Explore popular destinations like Devgad Beach, Malvan, Ratnagiri, and many hidden gems along the Tourkokan coast.',
  ...
  },
  {
    icon: '🤝',
    title: 'Community',
    desc: 'Join a community of explorers and share your Tourkokan travel stories with fellow adventurers.',
...
const stats = [
  { value: '720 km', label: 'Tourkokan Coastline', source: 'Maharashtra Tourism' },
  { value: '5M+', label: 'Annual Visitors', source: 'Maharashtra Tourism' },
  { value: '200+', label: 'Pristine Beaches', source: 'MTDC' },
  { value: '30+', label: "Chatrapati Shivaji Maharaj Era Forts", source: 'ASI India' },
  ...
  return (
    <div className="overflow-x-hidden">
      ...
      <section className="relative bg-gradient-to-b from-primary-50/60 to-white py-24 lg:py-32 dark:from-neutral-800/60 dark:to-neutral-900">
        <div className="container mx-auto max-w-4xl text-center">
          ...
          <h1 className="mx-auto mt-5 max-w-3xl text-4xl font-bold leading-tight text-neutral-900 sm:text-5xl lg:text-6xl dark:text-white">
            Your Gateway to the <span className="text-primary-600">Tourkokan Coast</span>
          </h1>
          <p className="mx-auto mt-6 max-w-2xl text-lg leading-relaxed text-neutral-500 dark:text-neutral-400">
            ...
            of the Tourkokan region. We give you everything you need to make every journey through Tourkokan unforgettable.
          </p>
      ...
      <section className="py-20 lg:py-28">
        <div className="container mx-auto max-w-6xl">
          <div className="mb-14 text-center">
            <h2 className="text-3xl font-bold text-neutral-900 dark:text-white">Everything you need to explore Tourkokan</h2>
            <p className="mx-auto mt-3 max-w-xl text-neutral-500 dark:text-neutral-400">
              Four pillars that make Tourkokan the most complete Tourkokan travel companion.
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 gap-16 lg:grid-cols-2">
            ...
            <div>
              ...
              <h2 className="mt-4 text-3xl font-bold text-neutral-900 dark:text-white">
                The most complete Tourkokan travel guide
              </h2>
            ...
            <div className="flex flex-col justify-between gap-8">
              <div className="rounded-3xl border border-neutral-200 bg-white p-8 dark:border-neutral-700 dark:bg-neutral-800">
                ...
                <p className="mt-3 leading-relaxed text-neutral-500 dark:text-neutral-400">
                  ...
                  latest events in Tourkokan. Your satisfaction and enjoyment are our top priorities.
                </p>
              </div>
              ...
              <div className="rounded-3xl bg-primary-600 p-8 text-white">
                ...
                <p className="mt-2 text-sm text-primary-100">
                  Download Tourkokan for free on Google Play and start your Tourkokan adventure today.
                </p>
                <div className="mt-5">
      ...
      <section className="py-20 lg:py-28">
        <div className="container mx-auto max-w-6xl">
          <div className="mb-14 text-center">
            <h2 className="text-3xl font-bold text-neutral-900 dark:text-white">🌊 Tourkokan by the Numbers</h2>
            <p className="mx-auto mt-3 max-w-lg text-neutral-500 dark:text-neutral-400">
              Real data behind Tourkokan&apos;s growing tourism story.
            </p>
          </div>
