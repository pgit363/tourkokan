  ...
  return (
    <div className="pt-10 pb-24 sm:py-24 lg:py-32">
      <div className="container mx-auto max-w-6xl">
        ...
        <div className="mb-16 grid grid-cols-1 gap-6 sm:grid-cols-3">
          {whyItems.map((item) => (
            <div key={item.titleKey} className="rounded-2xl border border-neutral-200 bg-white p-6 dark:border-neutral-700 dark:bg-neutral-800">
              ...
              <h3 className="font-semibold text-neutral-900 dark:text-white">{t.advertise[item.titleKey]}</h3>
              <p className="mt-2 text-sm text-neutral-500 leading-relaxed dark:text-neutral-400">{t.advertise[item.descKey]}</p>
            </div>
          ))}
        </div>
        ...
        {/* Packages */}
        <div className="mb-16">
          <h2 className="mb-8 text-center text-2xl font-bold text-neutral-900 dark:text-white">{t.advertise.packagesTitle}</h2>
        ...
        <div className="mx-auto max-w-2xl">
          <div className="mb-8 text-center">
            <h2 className="text-2xl font-bold text-neutral-900 dark:text-white">{t.advertise.quoteTitle}</h2>
            <p className="mt-2 text-neutral-500 dark:text-neutral-400">
              {t.advertise.quoteSubtitle}
            </p>
          </div>
