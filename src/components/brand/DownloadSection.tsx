        ...
        <div className="flex flex-col items-center gap-12 lg:flex-row lg:justify-between">
          ...
          <div className="max-w-lg text-center lg:text-left">
            ...
            <div className="mt-8 flex flex-wrap items-center justify-center gap-6 lg:justify-start">
              <div className="flex items-center gap-2 text-orange-100">
                ...
                <span className="text-sm font-medium">{t.home.trustRating}</span>
              </div>
              <div className="flex items-center gap-2 text-orange-100">
                ...
                <span className="text-sm font-medium">{t.home.trustFreeSecure}</span>
              </div>
              <div className="flex items-center gap-2 text-orange-100">
                <svg className="h-5 w-5 text-blue-300" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M12 18h.01M8 21h8a2 2 0 002-2V5a2 2 0 00-2-2H8a2 2 0 00-2 2v14a2 2 0 002 2z" />
                </svg>
                <span className="text-sm font-medium">{t.home.trustPlatforms}</span>
              </div>
            </div>
          </div>
          ...
          <div className="flex flex-col items-center gap-6">
            <div className="rounded-3xl bg-white p-5 shadow-2xl">
              <p className="mb-3 text-center text-sm font-semibold text-neutral-700">{t.home.scanToDownload}</p>
              <Image
                src="/qr-code.png"
              ...
              />
              <p className="mt-3 text-center text-xs text-neutral-500">{t.home.googlePlayStore}</p>
            </div>
