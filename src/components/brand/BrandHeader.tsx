      ...
      <div className="container flex h-18 items-center justify-between py-3">
        ...
        <div className="hidden items-center gap-3 lg:flex">
          {isLoggedIn ? (
            ...
            <Link href="/login" className="rounded-full border border-neutral-200 px-4 py-1.5 text-sm font-medium text-neutral-700 transition hover:bg-neutral-50 dark:border-neutral-700 dark:text-neutral-300 dark:hover:bg-neutral-800">
              Sign in
            </Link>
          )}
          ...
          <div className="mt-4 border-t border-neutral-100 pt-4 dark:border-neutral-700">
            {isLoggedIn ? (
              ...
              <div className="flex gap-3">
                <Link href="/login" onClick={() => setMenuOpen(false)} className="flex-1 rounded-xl border border-neutral-200 py-2.5 text-center text-sm font-medium text-neutral-700 dark:border-neutral-700 dark:text-neutral-300">
                  Sign in
                </Link>
                <Link href="/signup" onClick={() => setMenuOpen(false)} className="flex-1 rounded-xl bg-primary-600 py-2.5 text-center text-sm font-medium text-white">
                  Sign up
                </Link>
              </div>
            )}
