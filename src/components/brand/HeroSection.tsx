      ...
      <div className="container relative flex min-h-screen flex-col items-center justify-center px-4 py-24 lg:flex-row lg:gap-16 lg:py-0">
        ...
        <div className="relative mt-16 flex flex-1 items-center justify-center lg:mt-0">
          <div className="relative">
            ...
            <div className="absolute right-0 top-32 z-20 hidden translate-x-1/2 items-center gap-2 rounded-2xl bg-green-500 px-3 py-2 shadow-xl sm:flex">
            ...
            <div className="absolute left-0 bottom-24 z-20 hidden -translate-x-1/2 items-center gap-2 rounded-2xl bg-primary-600 px-3 py-2 shadow-xl sm:flex">
              <div className="flex h-8 w-8 items-center justify-center rounded-full bg-white/20">
